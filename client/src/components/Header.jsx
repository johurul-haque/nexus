...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-slate-50/95 py-2 backdrop-blur-lg">
      <div className="container-padding mx-auto flex max-w-7xl items-center justify-between">
        ...
        >
          ...
          {user ? (
            <>
              <button
                className="rounded-full bg-slate-200/60 px-4 py-1 font-medium text-rose-700 outline-none ring-rose-500 ring-offset-2 transition-all duration-200 hover:bg-rose-200 focus-visible:ring-1 max-md:mt-3"
                onClick={() => {
                  logOut();
                  toggleMenu();
                }}
