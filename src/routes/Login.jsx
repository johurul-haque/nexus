    ...
    <main className="mx-auto my-16 max-w-xs text-center text-gray-800">
      ...
      <form className="grid gap-3 transition-all duration-200">
        ...
        <input
          ...
          required
        />
        <button className="h-12 rounded bg-gradient-to-br from-violet-600 to-fuchsia-600 text-lg font-semibold text-white outline-none ring-fuchsia-500 ring-offset-2 focus-visible:ring-2">
          Continue
        </button>
      </form>
      <p className="my-3">
