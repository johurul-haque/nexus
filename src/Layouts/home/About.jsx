      ...
      <div>
        ...
        <div className="max-w-[65ch] space-y-3 text-justify leading-relaxed tracking-wide max-lg:text-lg max-sm:mx-auto md:tracking-wider">
          <p>
            ...
            full potential. Our platform offers a diverse range of classes
            taught by experienced instructors, empowering students to explore
            various design disciplines and stay ahead in the ever-evolving world
            of design.
          </p>
          ...
          <p>
            ...
            or just starting your design journey, our carefully curated
            selection of classes caters to all skill levels and interests.
          </p>
          ...
          <p>
            ...
            captivating lessons that combine theoretical knowledge with
            practical applications, enabling you to create impactful designs and
